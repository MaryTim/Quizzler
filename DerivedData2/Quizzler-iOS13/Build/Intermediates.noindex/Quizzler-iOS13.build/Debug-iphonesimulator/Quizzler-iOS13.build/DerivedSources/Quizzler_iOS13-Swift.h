...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified answer1Button;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified answer2Button;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified answer3Button;
- (void)viewDidLoad;
